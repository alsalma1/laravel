...
<form action="anyadirCarrera" method="POST" accept-charset="UTF-8" class="formaddcarrera" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control" id="mapa" name="image" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control" id="cartel" name="promotion" required>
        </div>
    </div>
...
<p><a href="<?php echo e(url('paginaPrincipal')); ?>">Volver atrás</a></p><?php /**PATH C:\xampp\htdocs\bikeroll\resources\views/admin/carreras/anyadirCarrera.blade.php ENDPATH**/ ?>