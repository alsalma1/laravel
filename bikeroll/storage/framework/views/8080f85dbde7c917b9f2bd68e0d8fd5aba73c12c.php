        ...
        <tr>
            ...
            <?php 
                ...
                if (date($row['date'])<date('Y-m-d H:i:s')){   
                    ?><td><a href="activarAseguradora/<?php echo e($id); ?>"><img src="../resources/img/upload.png" alt=""></td><?php
                }
                else{
                    ?><td><a href="activarAseguradora/<?php echo e($id); ?>"><img src="../resources/img/bloquear.png" alt=""></td><?php
                }
            ?>
            <td><a href="activarAseguradora/<?php echo e($id); ?>"><img src="../resources/img/ver.png" alt=""></td>
